...
public class ArrowShots_AEC : MonoBehaviour, IAquariumEvent
{
    ...
    [Tooltip("�u an g�stermelik")]  public int ArrowCount = 3;
    ...
    public void Happen()
    {
        //her okun f�rlat�lma �izgisini ve ayr� f�rlat�lma zamanlar�n� belirle
        delay = ThrowDelay;
        ...
        //oklar�n ge�ece�i yolu g�ster ve biraz bekle
        StopAllCoroutines();
    ...
    void ThrowArrow()
    {
        ...
        //oku ba�lang�� konumuna b�rak�p hedef konuma f�rlat
        StartCoroutine(HitScanShot(thrown));

        //okun gitti�i �izgiyi raycast ile kontrol edip b�t�n �arpt�klar�n� �ld�r
    ...
    IEnumerator HitScanShot(int index)
    {
        ...
        while (true)
        {
            ...
            if (lerpy == 1)
            {
                // okun animasyonunu �al��t�r ki yok olsun
